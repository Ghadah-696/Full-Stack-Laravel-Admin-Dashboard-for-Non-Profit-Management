...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('BACKUP_NAME', 'laravel-demo'),
        ...
        'database_dumps' => [
            ...
            'mysql' => [
                // هذا هو المسار الذي يجب عليك تعديله ليناسب إصدار MySQL الخاص بك في Wamp.
                // **ملاحظة:** استخدم شرطتين مائلتين عكسيتين مزدوجتين (\\) لضمان التفسير الصحيح للمسار في PHP.
                // **ملاحظة:** يجب أن يكون المسار داخل علامتي تنصيص مزدوجتين.
                'dump_command_path' => '"C:\\wamp64\\bin\\mysql\\mysql9.1.0\\bin\\mysqldump.exe"',

                'use_mysql_set_charset' => null,
                'timeout' => 60 * 5, // 5 minutes max
                'extra_option' => '',
            ],

            // ... (باقي إعدادات قواعد البيانات الأخرى مثل pgsql، sqlite إلخ.) ...
        ],
        /*
